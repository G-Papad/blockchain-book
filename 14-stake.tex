...
The adversary can use $s$ to choose to extend whichever fork enables her to satisfy the inequality.
To avoid grinding attacks, we must remove $s$ and $x$ from the inequality and obtain
\[
  H(\pk) \leq T\,.
\]

This inequality does not look very healthy. We have lost all information about the block
...
% Reading: (advanced) Longest Chain Consensus Under Bandwidth Constraint