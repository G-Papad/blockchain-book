...
to avoid floating-point errors, a detail we are now abstracting away.
...
\begin{definition}[Target Function]
  ...
  a normalized stake value to a normalized target, with $\phi(0) = 0$, $\phi(1) = 1$.
\end{definition}
...
obtain a block for a given slot.
