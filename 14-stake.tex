...
called \emph{slots}\index{Slot}, with the intent of
...
Validation of the chain involves checking that all blocks are signed by a public key $\pk$ in the PKI
that satisfies the proof-of-stake inequality for the given slot.
At the beginning of each slot, the party checks the proof-of-stake inequality to see if they
are a block proposer. If so, they create a new block using their local mempool and pointing at the
