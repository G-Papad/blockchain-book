...
by including $s$ in the ticketing mechanism.  ensuring the proof-of-work is invalidated whenever the
...
The first provably secure longest-chain proof-of-stake system is Ouroboros~\cite{ouroboros}.
This protocol is used in practical systems such as Cardano and Polkadot. The first
