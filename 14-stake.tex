...
proposers. We prefer the case where there is exactly one proposer per slot. When there are multiple
...
was missing, the adversary could check a massive number of future slots in advance and leverage
all these tickets to create a chain today.

- Comment on slots not in the future
- Comment on increasing slot numbers
